...
public class CucumberExtentReporter {
    ...
    public CucumberExtentReporter(){
        ...
        extentHtmlReporter.config().setDocumentTitle("Mobile Financial Platform System Test Automation");
        extentHtmlReporter.config().setReportName("Mobile Financial Platform System Automation Test Report");
        extentHtmlReporter.config().setTheme(Theme.DARK);

        extentReports.setSystemInfo("Test Developed By", "Habitamu Azezew");
